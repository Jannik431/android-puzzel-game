...
public class Level3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Form l = FormFactory.getGrossesL();              l.setVerbleibendeAnzahl(1);
        Form z = FormFactory.getZ();                     z.setVerbleibendeAnzahl(1);
        Form rect1 = FormFactory.getKleinesRechteck();   rect1.setVerbleibendeAnzahl(1);
        Form i1 = FormFactory.getMittleresI();           i1.setVerbleibendeAnzahl(1);
        Form i2 = FormFactory.getLiegendesI();           i2.setVerbleibendeAnzahl(1);
        Form rect2 = FormFactory.getMikroRechteck();     rect2.setVerbleibendeAnzahl(1);


        List<Form> formenListe = Arrays.asList(l, z, rect1, i1, i2, rect2);
                ...
                while (true) {
                    ...
                    if (spielfeld != null && spielfeld.isComplete()) {
                        runOnUiThread(() -> {
                            ...
                            stopTimer();
                            Intent intent = new Intent(Level3Activity.this, LevelCompletedActivity.class);
